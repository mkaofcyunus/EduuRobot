...
- Create a new issue in our `GitHub <https://github.requmkaofcyunus/EduuRobot>`__ describing the issue.
- Send the /bug command to `bot's <https://t.me/mkasiribot>`__ chat describing the issue.
